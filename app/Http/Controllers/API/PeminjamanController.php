...
class PeminjamanController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        // Peminjam hanya bisa melihat peminjamannya sendiri
    ...
    public function update(
        ...
        if ($peminjaman->status !== 'diajukan') {
            return response()->json([
                'message' =>
                    "Peminjaman tidak dapat diubah karena status saat ini: {$peminjaman->status}."
            ], 400);
        }
        ...
        try {
            ...
            return response()->json([
                'message' =>
                    'Data permohonan peminjaman berhasil diperbarui.',
                'data' => new PeminjamanResource(
                    $peminjaman->load([
                        'user',
                        'detailPinjam.alat'
    ...
    public function destroy(Peminjaman $peminjaman): JsonResponse
    {
        ...
        return response()->json([
            'message' =>
                'Permohonan peminjaman berhasil dibatalkan dan dihapus.'
        ]);
    }
